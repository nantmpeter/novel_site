		...
		<form id="install" action="<?php echo U('index/install');?>" method="post">
			<ul>
				...
				<tr>
					...
					<td>将YGBOOK安装到哪个数据库？请先创建数据库</td>
				</tr>
				<tr>
					<td><strong>数据表前缀：</strong></td>
					<td>
						<input type="text" name="prefix" class="textInput" value="yg_" required="true" />
					</td>
					<td>如果您希望在同一个数据库安装多个YGBOOK，请修改前缀。</td>
				</tr>
				</table>
				<h3>后台管理员帐号</h3>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
