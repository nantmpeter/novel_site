...
<head>
	...
	<title>小说搜索结果_<?php echo ($TDK["webname"]); ?></title>
...
<section class="ptm-content">
	...
	<div class="ptm-card">
		<div class="ptm-card-header ptm-clearfix">
			<div class="ptm-pull-left">
				搜索：“<font color=red><?php echo ($q); ?></font>”相关的小说
			</div>
			<div class="ptm-pull-right"></div>
		</div>
		<div class="ptm-card-content" style="padding:0">
			<ul class="ptm-list-view ptm-grid-view pt-card-1">
			<?php if(is_array($articlelist)): foreach($articlelist as $key=>$v): ?><li class="ptm-list-view-cell ptm-img ptm-col-xs-4">
					<div class="imgarea">
