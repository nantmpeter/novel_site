...
<div class="nav">
	...
	<div id="main">
		<div id="hotcontent">
			<div class="ll">
				<?php if(is_array($hotlist)): foreach($hotlist as $key=>$v): ?><div class="item">
					<div class="image">
						<a href="<?php echo ($v['rewriteurl']); ?>" title="<?php echo ($v['title']); ?>"><img <?php echo ($comset["src"]); ?>="<?php echo ($v['thumb']); ?>" alt="<?php echo ($v['title']); ?>" width="120" height="150" onerror="this.src='/Public/images/nocover.jpg'" /></a>
					</div>
					<dl>
						<dt><span><a href="<?php echo reurl('author', $v);?>" target="_blank" title="<?php echo ($v["author"]); ?>"><?php echo ($v["author"]); ?></a></span><a href="<?php echo ($v['rewriteurl']); ?>"><?php echo ($v['title']); ?></a></dt>
		...
		<div id="hotcontent">
			<div class="lll">
				<h2><?php echo ($TDK["webname"]); ?>小说大全</h2>
				<ul>
